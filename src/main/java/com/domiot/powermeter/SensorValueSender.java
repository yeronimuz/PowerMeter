package com.domiot.powermeter;

import com.domiot.powermeter.config.MqttConfigImpl;
import com.domiot.powermeter.config.MqttTopicConfig;
import com.domiot.powermeter.config.TopicType;
...
public class SensorValueSender implements Runnable
{
   ...
   private void connectToBroker(MqttConfigImpl mqttConfigImpl)
