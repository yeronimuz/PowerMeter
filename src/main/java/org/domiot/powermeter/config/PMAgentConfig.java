package org.domiot.powermeter.config;
...
public class PMAgentConfig {
	...
	@JsonProperty
	private MqttConfigImpl mqttConfigImpl = new MqttConfigImpl();
	 ...
	 */
	public MqttConfigImpl getMqttConfig() {
	 ...
	 * Set mqttConfig.
	 *
	 * @param mqttConfigImpl the mqttConfig to set
	 */
	public void setMqttConfig(MqttConfigImpl mqttConfigImpl) {
	...
	public static PMAgentConfig loadConfigurationFromFile(String configFileName) throws IOException {
		...
		pmAgentConfigTypeDescription.addPropertyParameters("mqttConfig", MqttConfigImpl.class);
		...
		TypeDescription mqttConfigTypeDescription = new TypeDescription(MqttConfigImpl.class);
	...
	public String toString() {
		return "PMAgentConfig{" + "repeatValuesAfter=" + repeatValuesAfter + ", internalQueueSize=" + internalQueueSize
				+ ", sensorConfig=" + sensorConfig + ", serialPortConfig=" + serialPortConfig + ", mqttConfig="
				+ mqttConfigImpl + '}';
	}
}
