package org.domiot.powermeter.p1;
...
public enum P1Standard {
	...
	EQUIPMENT_ID_01("0-1:96.1.0", "Equipment identifier"), EQUIPMENT_ID_00("0-0:96.1.1", "Equipment identifier"),
	...
	DELIVERED_POWER_TARIFF_2("1-0:2.8.2", "produced power T2"), CURRENT_TARIFF("0-0:96.14.0", ""), // 2
	ACTUAL_CONSUMED_PWR("1-0:1.7.0", ""), // kW
	ACTUAL_DELIVERED_PWR("1-0:2.7.0", ""), // kW
	/**
	 * nr.of. power failures in any phase
	 */
	NR_OF_POWER_FAILURES_IN_ANY_PHASE("0-0:96.7.21", ""), NR_OF_LONG_POWER_FAILURES_IN_ANY_PHASE("0-0:96.7.9", ""),
	POWER_FAILURE_EVENT_LOG("1-0:99.97.0", ""), NR_OF_VOLTAGE_SAGS_IN_PHASE_L1("1-0:32.32.0", ""),
	NR_OF_VOLTAGE_SAGS_IN_PHASE_L2("1-0:32.36.0", ""), TEXT_MESSAGE_CODES("0-0:96.13.1", ""), // numeric 8 digits
	TEXT_MESSAGE("0-0:96.13.0", ""), // max 1024 chars
	INSTANTANEOUS_CURRENT_L1("1-0:31.7.0", ""), INSTANTANEOUS_ACTIVE_POWER_L1_PLUS_P("1-0:21.7.0", ""), // (kW)
	INSTANTANEOUS_ACTIVE_POWER_L1_MIN_P("1-0:22.7.0", ""), DEVICE_TYPE("0-1:24.1.0", ""), // Device Type (003)
