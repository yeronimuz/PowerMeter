...
public class P1Datagram {
	...
	@JsonIgnore
	/**
	 * The key is actually not conforming to separation of concerns principle It is
	 * used for local storage of datagrams (YYMMddHHss)
	 */
	private String key;
	...
	/**
	 * @param nrOfLongPowerFailuresInAnyPhase the nrOfLongPowerFailuresInAnyPhase to
	 *                                        set
	 */
	...
	/**
	 * @param instantaneousActivePowerL1PlusP the instantaneousActivePowerL1PlusP to
	 *                                        set
	 */
	...
	/**
	 * @param instantaneousActivePowerL1MinP the instantaneousActivePowerL1MinP to
	 *                                       set
	 */
