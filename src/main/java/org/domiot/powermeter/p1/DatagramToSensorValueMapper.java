...
public class DatagramToSensorValueMapper {
	...
	public static List<SensorValue> convertP1Datagram(SensorNode sensorNode, P1Datagram datagram) {
		...
		return Arrays.asList(
				new SensorValue(sensorNode, ts, MeasurementType.CONSUMED_POWER_T1.getId(),
						datagram.getConsumedPowerTariff1()),
				new SensorValue(sensorNode, ts, MeasurementType.PRODUCED_POWER_T1.getId(),
						datagram.getProducedPowerTariff1()),
				new SensorValue(sensorNode, ts, MeasurementType.CONSUMED_POWER_T2.getId(),
						datagram.getConsumedPowerTariff2()),
				new SensorValue(sensorNode, ts, MeasurementType.PRODUCED_POWER_T2.getId(),
						datagram.getProducedPowerTariff2()),
				new SensorValue(sensorNode, ts, MeasurementType.ACTUAL_CONSUMED_POWER.getId(),
						datagram.getActualConsumedPwr()),
				new SensorValue(sensorNode, ts, MeasurementType.ACTUAL_PRODUCED_POWER.getId(),
