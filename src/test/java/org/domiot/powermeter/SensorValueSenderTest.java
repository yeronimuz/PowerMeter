...
import org.domiot.powermeter.SensorValueSender;
...
class SensorValueSenderTest {
	...
	@BeforeAll
	static void doSetup() throws IOException {
	...
	private void setField(SensorValueSender sensorValueSender, String fieldName, Object object)
		...
		List<Field> fields = ReflectionUtils.findFields(SensorValueSender.class, f -> f.getName().equals(fieldName),
				TOP_DOWN);
