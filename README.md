# PowerMeter
###The bigger story
This project was born when I didn't want my P1 data to get saved in the cloud. To be honest, The energy net manager already has a snapshot of my data in order to be able to do billing of the consumed power.
