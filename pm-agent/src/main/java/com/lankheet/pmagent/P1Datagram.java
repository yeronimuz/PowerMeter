...
public class P1Datagram {
	...
	private double deliveredPowerTariff1;
	...
	public double getDeliveredPowerTariff1() {
		return deliveredPowerTariff1;
	}
	/**
	 * @param deliveredPowerTariff1 the deliveredPowerTariff1 to set
	 */
	public void setDeliveredPowerTariff1(double deliveredPowerTariff1) {
		this.deliveredPowerTariff1 = deliveredPowerTariff1;
	}
	/**
